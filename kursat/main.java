public class Main {
    public static void main(String[] args) {
        ...
        Tutor mathTutor = new Tutor("Kursat turgut", "MAT101");
        Tutor scienceTutor = new Tutor("Onat Karabulur", "SCI101");
        Tutor artsTutor = new Tutor("Ex Ebru", "ART101");

        math101.addTutor(mathTutor);
        science101.addTutor(scienceTutor);
        arts101.addTutor(artsTutor);

        Student student1 = new Student("EBRUSH", "1001", 1, math101, science101, arts101);
        student1.addMidtermResults(52, 27 ,41);
        student1.addFinalResults(60,58,45);
        student1.printStatus();

        Student student2 = new Student("SEvgi", "1002", 1, math101, science101, arts101);
        student2.addMidtermResults(70,68,92);
        student2.addFinalResults(81,71,78);
        student2.printStatus();

        Student student3 = new Student("Yok :)", "1003", 1, math101, science101, arts101);
